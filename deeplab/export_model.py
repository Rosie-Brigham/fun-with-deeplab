...
#     --checkpoint_path=deeplab/datasets/pqr/exp/train_on_trainval_set/train/model.ckpt-1000 \
#     --export_path=deeplab/datasets/pqr/exp/train_on_trainval_set/trained_model/frozen_inference_graph.pb
...
def main(unused_argv):
  ...
  with tf.Graph().as_default():
    ...
    graph_def = tf.Graph().as_graph_def(add_shapes=True)
